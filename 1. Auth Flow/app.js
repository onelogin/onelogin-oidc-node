...
const OIDC_BASE_URI = `https://${process.env.ONELOGIN_SUBDOMAIN}.onelogin.com/oidc`;
...
app.get('/logout', function(req, res){
  ...
  request.post(`https://${process.env.ONELOGIN_SUBDOMAIN}.onelogin.com/oidc/token/revocation`, {
    'form':{
